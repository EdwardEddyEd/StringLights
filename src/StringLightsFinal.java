...
public class StringLightsFinal extends Canvas implements Runnable{

	private static final long serialVersionUID = 8097886865369054985L;
	...
	private void initializeHelpMenu(){
		...
		help_g.setFont(new Font("Haettenschweiler", Font.BOLD, 14));
		help_g.drawString("By Edward Camp", 18, 385);
	...
	public static void main(String[] args){
		StringLightsFinal panel = new StringLightsFinal();
		...
		JFrame frame = new JFrame(StringLightsFinal.TITLE);
		frame.add(panel);
		frame.pack();
